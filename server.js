...
const translations = {
    ...
    // Pour les autres langues (pt, es, ar, zh), on pourrait les ajouter avec la même structure.
    // Par souci de concision, je ne les écris pas ici, mais elles doivent être présentes dans le code final.
    pt: { /* ... */ },
    es: { /* ... */ },
    ar: { /* ... */ },
    zh: { /* ... */ }
