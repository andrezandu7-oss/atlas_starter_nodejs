...
<style>
    ...
    /* ÉCRAN PROFIL */
    .profile-card { background: white; padding: 30px 20px; text-align: center; border-radius: 0 0 30px 30px; }
...
app.get('/signup', (req, res) => {
    ...
    <body><div class="app-shell"><div class="page-white">
        ...
        <form onsubmit="saveData(event)">
            ...
            <div class="oath-box">
                ...
                <label for="oath" style="font-size:0.8rem; color:#1a2a44;">Je jure que les données fournies sont exactes et sincères.</label>
            </div>
    ...
    <script>
        ...
        function saveData(e){
            ...
            window.location.assign('/profile'); // Transition directe
        }
    </script></body></html>`);
});

// --- PAGE PROFIL (RÉSULTAT) ---
app.get('/profile', (req, res) => {
    ...
    <body style="background:#f8f9fa;"><div class="app-shell">
        ...
        <button class="btn-dark" style="margin:20px;" onclick="window.location.href='/matching'">🔍 Trouver un partenaire</button>
    </div>
    <script>
...
// --- PARAMÈTRES (AVEC SIGNATURE V60.0) ---
app.get('/settings', (req, res) => {
    ...
    <body style="background:#f4f7f6;"><div class="app-shell">
        ...
        <div class="st-group">
            <div class="st-item" onclick="window.location.href='/signup'"><span>Modifier mon profil</span><b>➔</b></div>
            <div class="st-item"><span>Export PDF Santé</span><b style="color:#ff416c;">Bientôt</b></div>
        </div>
        <button class="btn-pink" onclick="window.location.href='/profile'">Retour au profil</button>
        <div style="text-align:center; font-size:0.75rem; color:#bbb; margin-top: auto; padding-bottom: 20px;">Version 60.0 - Genlove © 2026</div>
    </div></body></html>`);
});
