...
// On augmente la limite pour la photo de profil
...
<head>
    ...
    <style>
        ...
        .slider { position: absolute; cursor: pointer; inset: 0; background-color: #ccc; border-radius: 24px; transition: .4s; }
...
<body>
    <div class="app-shell">
        ...
        <div id="scr-signup" class="screen-layer">
            <div id="loader"><div class="spinner"></div><h3>Mise à jour sécurisée...</h3></div>
            <div style="padding: 25px; text-align: center;">
                <h2 id="form-title" style="color:#ff416c;">Configuration Santé</h2>
                <form onsubmit="saveProfile(event)">
                    ...
                    <button type="submit" id="btn-submit" class="btn-pink">🚀 Valider le profil</button>
                </form>
            </div>
        </div>
        ...
        <div id="scr-profile" class="screen-layer" style="background:#f8f9fa;">
            ...
            <div style="padding:15px 20px 5px; font-size:0.75rem; color:#888; font-weight:bold;">MES INFOS SANTÉ</div>
            <div class="st-group">
            ...
            <button class="btn-dark" onclick="showNotify('Recherche de partenaires...')">🔍 Trouver un partenaire</button>
        </div>
        ...
        <div id="scr-settings" class="screen-layer" style="background:#f4f7f6;">
            ...
            <div class="st-group">
                <div onclick="openEditMode()" style="cursor:pointer;" class="st-item"><span>Modifier mon profil</span><b>➔</b></div>
    ...
    <script>
        ...
        function checkAuth() {
            ...
            else showNotify("Aucun compte trouvé.");
        }
        ...
        // LE PACTE : ON NE MODIFIE QUE CE QUE L'ON VEUT
        function openEditMode() {
            document.getElementById('form-title').innerText = "Modification Ciblée";
            document.getElementById('btn-submit').innerText = "💾 Enregistrer les changements";
            
            // On remplit les cases avec les valeurs actuelles
