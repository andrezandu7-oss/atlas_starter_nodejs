...
<style>
    ...
    /* ASTUCE POUR AFFICHER LE TEXTE DANS LE CHAMP DATE */
...
app.get('/profile', (req, res) => {
    ...
    <body style="background:#f8f9fa;"><div class="app-shell">
        ...
        <a href="#" class="btn-dark" style="margin:20px; width:auto; text-decoration:none;">🔍 Trouver un partenaire</a>
    </div>
    <script>
...
app.get('/settings', (req, res) => {
    ...
    <body style="background:#f4f7f6;"><div class="app-shell">
        ...
        <div style="text-align:center; font-size:0.75rem; color:#bbb; padding:20px;">Version 61.2 - Genlove © 2026</div>
    </div></body></html>`);
});
