...
// ==========================================
// STYLES & SCRIPTS PARTIE 1 (Genlove principal)
// ==========================================
const styles = `<style>
...
// ==========================================
// SIMULATION CHAT (PARTIE 2) - Route /chat
// ==========================================
app.get('/chat', (req, res) => {
    const genloveChat = `<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
        ...
        function showFinal(type, auto = false) {
            ...
            if(type === 'chat') {
                ...
                card.innerHTML = `
                    ...
                    <button class="btn-restart" style="background:#1a2a44;" onclick="location.href='/';">Quitter</button>
