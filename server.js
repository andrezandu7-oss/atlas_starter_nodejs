...
app.get('/signup-full', (req, res) => {
    ...
    <head>
        ...
        <style>
            ...
            .info-yellow { background: #fffbe6; border: 1px solid #ffe58f; padding: 8px; border-radius: 10px; font-size: 0.7rem; margin-top: 10px; }
            .footer-btns { display: grid; grid-template-columns: 1.5fr 1fr; gap: 10px; margin-top: 25px; }
            .btn-final { background: #4caf50; color: white; border: none; padding: 15px; border-radius: 5px; font-weight: bold; cursor: pointer; font-size: 0.9rem; }
    ...
    <body>
        <div class="container">
            ...
            <form>
                ...
                <p style="font-weight:bold; font-size:0.75rem; margin:15px 0 5px 0;">Informations médicales :</p>
                <div class="grid">
                    <select><option>Groupe sanguin</option><option>A+</option><option>O+</option><option>B+</option><option>AB+</option><option>A-</option><option>O-</option><option>B-</option><option>AB-</option></select>
                ...
                <div class="footer-btns">
                    <button type="button" class="btn-final" onclick="alert('🚀 Inscription envoyée ! Notre IA vérifie vos documents. Vous recevrez une notification sous 24h.')">🚀 Finaliser mon inscription</button>
