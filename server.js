...
<head>
    ...
    <style>
        ...
        .btn-dark { background: #1a2a44; color: white; padding: 18px; border-radius: 15px; text-align: center; font-weight: bold; width: 100%; max-width: 280px; border: none; cursor: pointer; font-size: 1rem; margin-bottom: 10px; }
    ...
    <div class="app-shell">
        ...
        <div id="scr-home" class="screen-layer active" style="display:flex;">
            <div class="home-content">
                ...
                <div onclick="showScreen('scr-signup')" style="color:#1a2a44; font-weight:700; cursor:pointer; display:flex; align-items:center; gap:8px; margin-top:15px;">
