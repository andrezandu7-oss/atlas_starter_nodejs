...
<style>
    ...
    /* CAMERA V43 - RECTO/VERSO & TRIGGER */
    ...
    .btn-rec-trigger.active { background: #ff416c; }
    .btn-switch { background: rgba(0,0,0,0.5); color: white; border: none; padding: 10px; border-radius: 50%; cursor: pointer; }
...
app.get('/signup', (req, res) => {
    ...
    <body><div class="app-shell"><div class="signup-page">
        ...
        <form onsubmit="validateForm(event)">
            ...
            <p style="text-align: left; font-size: 0.7rem; color: #666;">Cadrage : 1 mètre. Utilisez le bouton central pour lancer les 5s.</p>
...
app.listen(port, () => console.log('Genlove V43 - Expérience Caméra Manuelle Ready'));
