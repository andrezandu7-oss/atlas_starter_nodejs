...
// --- INSCRIPTION AVEC TOUS LES GROUPES SANGUINS ET EXEMPLES ---
app.get('/signup-full', (req, res) => {
    ...
    <head>
        ...
        <style>
            ...
            .upload-btn { border: 2px dashed #ff416c; padding: 12px; border-radius: 10px; text-align: center; color: #ff416c; font-size: 0.8rem; font-weight: bold; margin-top: 15px; cursor: pointer; display: block; }
            .btn-final { background: #4caf50; color: white; border: none; padding: 15px; border-radius: 8px; font-weight: bold; cursor: pointer; width: 100%; margin-top: 20px; }
    ...
    <body>
        ...
        <div class="container">
            ...
            <form>
                ...
                <label for="vInp" id="vLb" class="upload-btn" style="border-color:#2196F3; color:#2196F3;">🎥 Vidéo de vérification (20s)</label>
                <input type="file" id="vInp" style="display:none" accept="video/*" capture="user" onchange="videoDone()">

                <button type="button" class="btn-final" onclick="saveAndGo()">🚀 Finaliser mon inscription</button>
                <a href="/" style="display:block; text-align:center; margin-top:15px; color:#999; text-decoration:none; font-size:0.8rem;">Retour</a>
            </form>
        </div>
        ...
        <script>
            ...
            function saveAndGo() {
                if(!vCap) { alert("Veuillez enregistrer votre vidéo de vérification."); return; }
...
app.get('/dashboard', (req, res) => {
    ...
    <head>
        ...
        <style>
            ...
            .value { color: #666; }
            .btn-edit { width: 100%; padding: 15px; border-radius: 12px; border: 1px solid #ddd; background: white; margin-top: 30px; font-weight: bold; text-align:center; text-decoration:none; display:block; color:black; }
        </style>
    </head>
    <body>
        <div class="iphone">
        ...
        <script>
            ...
            if(d) {
                document.getElementById('cont').innerHTML = \`
                    <div class="item"><span class="label">Prénom</span> <span class="value">\${d.fn}</span></div>
                    <div class="item"><span class="label">Nom</span> <span class="value">\${d.ln}</span></div>
