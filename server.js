...
// ============================================
// ============================================
// INSCRIPTION QR - NOTRE DESIGN + TON SCAN
// ============================================
...
<body>
    <div class="app-shell">
        ...
        <div class="page-white">
            ...
            <p style="margin-bottom: 10px;">Scannez votre QR code médical</p>
            
            <!-- SCANNER -->
            <div id="reader"></div>
            
            <form id="regForm" action="/api/register-qr" method="POST">
                <input type="hidden" name="isVerified" value="true">
                
                <!-- DONNÉES DU CERTIFICAT -->
                <div class="certificate-box">
                    <h4>✅ ${t('dataFromCertificate')}</h4>
                    
                    <div class="input-label">${t('firstName')}</div>
                    <input type="text" id="fn" name="firstName" placeholder="${t('firstName')}" readonly class="input-box" required>
                    
                    <div class="input-label">${t('lastName')}</div>
                    <input type="text" id="ln" name="lastName" placeholder="${t('lastName')}" readonly class="input-box" required>
                    
                    <div class="input-label">${t('genotype')}</div>
                    <input type="text" id="gt" name="genotype" placeholder="${t('genotype')}" readonly class="input-box" required>
                    
                    <div class="input-label">${t('bloodGroup')}</div>
                    <input type="text" id="bg" name="bloodGroup" placeholder="${t('bloodGroup')}" readonly class="input-box" required>
                    
                    <!-- DATE DE NAISSANCE - 3 CASES ÉLÉGANTES -->
                    <div class="input-label" style="margin-top: 15px;">${t('dob')}</div>
                    <div class="date-row">
                        <input type="text" id="d" class="date-input" placeholder="JJ" readonly>
                        <input type="text" id="m" class="date-input" placeholder="MM" readonly>
                        <input type="text" id="y" class="date-input" placeholder="AAAA" readonly>
                    </div>
                ...
                <input type="text" name="residence" placeholder="${t('city')}" class="input-box" required>
                
                <div class="input-label">${t('region')}</div>
                <input type="text" name="region" placeholder="${t('region')}" class="input-box" required>
                ...
                <button type="submit" class="btn-pink" id="submitBtn">${t('createProfile')}</button>
            </form>
