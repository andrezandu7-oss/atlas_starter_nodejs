...
<body>
        ...
        <div id="scr-signup" class="screen-layer">
            ...
            <div style="padding: 25px; text-align: center;">
                ...
                <form onsubmit="saveProfile(event)">
                    ...
                    <button type="submit" id="btn-submit-form" class="btn-pink">🚀 Valider mon profil</button>
                </form>
            </div>
        </div>
    ...
    <script>
        ...
        function openEditMode() {
            // On pré-remplit les champs avec l'existant
            document.getElementById('form-title').innerText = "Modifier mon profil";
            document.getElementById('btn-submit-form').innerText = "💾 Enregistrer les modifications";
        ...
        function saveProfile(e){
            ...
            // Sauvegarde de toutes les cases (celles changées et celles restées telles quelles)
        ...
        function showNotify(msg) {
            const n = document.getElementById('genlove-n
